...
const file_proto_user_proto_rawDesc = "" +
	...
	".user.UserR\x04user2\xb7\x02\n" +
	"\vUserService\x12=\n" +
	"\fRegisterUser\x12\x19.user.RegisterUserRequest\x1a\x12.user.UserResponse\x128\n" +
	"\tLoginUser\x12\x16.user.LoginUserRequest\x1a\x13.user.LoginResponse\x123\n" +
	...
	"\n" +
	"DeleteUser\x12\x17.user.DeleteUserRequest\x1a\x18.user.DeleteUserResponseBOZMgithub.com/ZhantoreGaineden/FinalProjectAdvancedProgramming2/proto/gen/userpbb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	...
	8, // 7: user.UserService.RegisterUser:output_type -> user.UserResponse
	3, // 8: user.UserService.LoginUser:output_type -> user.LoginResponse
	8, // 9: user.UserService.GetUser:output_type -> user.UserResponse
